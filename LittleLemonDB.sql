...
CREATE TABLE `bookings` (
  ...
  KEY `customer_id_fk_booking_idx` (`CustomerID`),
  CONSTRAINT `customer_id_fk_booking` FOREIGN KEY (`CustomerID`) REFERENCES `customers` (`CustomerID`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2023-06-29  8:36:36
